...
class FastBurstFilterMigratedFromLog4j2Test {
    ...
    private final FastBurstFilter filter;
    private final Logger logger;

    public FastBurstFilterMigratedFromLog4j2Test(final LoggerContext context, @Named("ListAppender") final ListAppender app) {
        this.app = app;
        this.filter = (FastBurstFilter) app.getFilter();
